...
### [found via live web search this run] Dynamic Negative Sampling (DNS) improves BPR over uniform sampling at minimal extra cost  (Zhang, Chen, Wang & Yu 2013, SIGIR ("Optimizing Top-N Collaborative Filtering via Dynamic Negative Item Sampling"))
